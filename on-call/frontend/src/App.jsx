      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900 leading-tight">OHNS On-Call Scheduler</h1>
              <p className="text-xs text-gray-600 font-medium">Resident Scheduling System</p>
            </div>
          </div>
